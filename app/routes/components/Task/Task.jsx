...
export const Task = ({id,title,metakey,onRemove}) => {
    ...
    return (
        <div className="main_list_wrapper">
            <Modal title={title} id={id} metakey={metakey} />
            ...
            {(title !== "Price" && title !== "Collection" && title !== "Vendor") && (
